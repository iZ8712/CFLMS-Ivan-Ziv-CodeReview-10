    ...
    <div class="acbox">
        ...
        <?php
            ...
            if($_POST) {
                ...
                $sql = "INSERT INTO `media`(`COVER`, `TITLE`,`AUTHOR`, `DESCRIPTION`, `TYPE`, `STATUS_OF_BOOK`,`PUBLISHED`, `PUBLISHER`, `ISBN`) 
                VALUES ('$cover', '$title', '$author', '$description', '$type', '$status', '$published', '$publisher', '$isbn')";
                if(mysqli_query($conn, $sql)) {
                    echo "
                    <div class='card bookbg' style='width: 18rem;'>
                        <button class='btn btn-success btn-lg btn-block'>Book successfully added!</button>
                        <img src='$cover'>
                        <div class='card-body'>
